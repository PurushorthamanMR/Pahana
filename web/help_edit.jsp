            ...
            <div class="main-content">
                ...
                <div class="header">
                    <div class="header-left">
                        ...
                        <h1 class="h3 mb-0">Edit Help Section</h1>
                    </div>
                    <div class="user-info">
                    ...
                    <form action="HelpServlet" method="POST" id="helpForm">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="content" name="content" rows="10" 
                                      placeholder="Enter help section content" required><%= helpSection.getContent() %></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                ...
                                <% } else if ("MANAGER".equals(currentRole)) { %>
                                    You can only edit help sections for CUSTOMER users
                                <% } %>
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Update Help Section
                            </button>
